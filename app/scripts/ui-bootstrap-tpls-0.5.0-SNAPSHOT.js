...
.controller('ProgressBarController', ['$scope', '$attrs', 'progressConfig', function($scope, $attrs, progressConfig) {
    ...
    var autoText = angular.isDefined($attrs.autoText) ? $scope.$eval($attrs.autoText) : progressConfig.autoText;
    ...
    this.makeBar = function(newBar, oldBar, index) {
		...
		var text = (angular.isObject(newBar) && angular.isDefined(newBar.text)) ? newBar.text : (autoText) ? newValue + '%' : null;
...
angular.module("template/progressbar/bar.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/progressbar/bar.html",
    "<div class=\"bar\" ng-class='type && \"bar-\" + type' ng-bind=\"text\"></div>");
}]);

angular.module("template/progressbar/progress.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/progressbar/progress.html",
    "<div class=\"progress\"><progressbar ng-repeat=\"bar in bars\" width=\"bar.to\" old=\"bar.from\" animate=\"bar.animate\" type=\"bar.type\" text=\"bar.text\"></progressbar></div>");
}]);
